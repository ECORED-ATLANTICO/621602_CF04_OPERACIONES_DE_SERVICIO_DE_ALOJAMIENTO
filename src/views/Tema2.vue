...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.mb-5.justify-content-center.align-items-center
      ...
      .col-lg-9
        p.mb-4(data-aos="fade-right") El rooming list es un documento utilizado principalmente en reservas grupales, donde se registra la información detallada de los huéspedes que harán parte de una reserva colectiva. Este listado es enviado generalmente por agencias de viajes, empresas u organizadores de eventos y contiene datos como nombres de los huéspedes, tipo de habitación, fechas de llegada y salida, requerimientos especiales y distribución de habitaciones.

        .bg-fondo-9.px-lg-5.py-lg-4.px-4.py-3.br-15
          p.mb-0 La finalidad del rooming list es facilitar la organización operativa del hotel antes de la llegada del grupo, permitiendo coordinar procesos de check-in, asignación de habitaciones, alimentación y servicios complementarios. Además, este documento mejora la comunicación entre las áreas de reservas, recepción y housekeeping, optimizando la atención al cliente y reduciendo errores en la operación.

    .row.justify-content-center.align-items-center.mb-5
      .col-lg-12
        .titulo-sexto.color-acento-contenido.mb-4
          h5.text-bold Figura 1.
          span Reserva grupal o rooming list en software hotelero
    ...
    .bloque-texto-g.bloque-texto-g--inverso.bg-color-21.p-3.p-sm-4.p-md-5.mb-5
      ...
      .bloque-texto-g__texto.p-4
        p.mb-3 La waiting list o lista de espera es una herramienta utilizada cuando el hotel no cuenta con disponibilidad inmediata de habitaciones, pero registra las solicitudes de clientes interesados ante posibles cancelaciones o modificaciones de reservas existentes.
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-10
        .cajon.bg-color-74.p-4
          p.mb-0 La adecuada gestión de la waiting list contribuye a maximizar la ocupación y mantener comunicación con clientes potenciales, evitando pérdidas de ingresos por habitaciones vacías.

    .row.justify-content-center.align-items-center.mb-5
      .col-lg-12
        .titulo-sexto.color-acento-contenido.mb-4
          h5.text-bold Figura 2.
          span Lista de espera o waiting list en software hotelero
    ...
    #t_2_3.titulo-segundo.color-acento-contenido(data-aos="flip-up")
      h2 2.3 Forecasting (pronóstico de ocupación)
    ...
    .row.mb-5.justify-content-center.align-items-center
      ...
      .col-lg-9
        p.mb-3(data-aos="fade-right") El forecasting corresponde al pronóstico o estimación de ocupación hotelera basado en el análisis de reservas actuales, comportamiento histórico de la demanda, temporadas y tendencias del mercado. Esta herramienta permite anticipar niveles de ocupación y planificar estrategias comerciales y operativas.
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-12.col-lg-7.col-md-12.mb-4.mb-lg-0
        .titulo-sexto.color-acento-contenido.mb-4
          h5 
            b Tabla 3.
          span Variables utilizadas en el forecasting
    ...
    .container
      .row.justify-content-center.align-items-center.mb-5.bg-color-9(data-aos="fade-right")
        .col-lg-7.p-4.order-2.order-lg-1
          p.mb-0 El overbooking o sobreventa ocurre cuando el hotel vende más habitaciones de las realmente disponibles, anticipando cancelaciones o no presentaciones de huéspedes. Esta práctica se utiliza como estrategia para evitar pérdidas económicas derivadas de habitaciones vacías.
    ...
    .row.mb-5.justify-content-center.align-items-center
      ...
      .col-lg-9
        p.mb-3(data-aos="fade-right") Aunque el overbooking puede contribuir a maximizar ingresos, también representa un riesgo operativo y de servicio si todos los huéspedes se presentan al mismo tiempo. En estos casos, el hotel debe aplicar protocolos de reubicación o compensación para evitar afectar la experiencia del cliente.
        p.mb-3 El manejo del overbooking requiere un análisis cuidadoso del comportamiento histórico de cancelaciones y no show, así como una adecuada coordinación operativa.
        p.mb-0 A continuación, se presentan las ventajas y riesgos del overbooking en hotelería:
    ...
    .row.justify-content-center.mb-5
      .col-12.col-lg-12
        .titulo-sexto.color-acento-contenido.mb-4
          h5 
            b Tabla 4.
          span Ventajas y riesgos del #[i overbooking]
        .tabla-a.color-acento-contenido 
          table
            ...
            thead
              tr
                th Aspecto
                th Ventajas del #[i overbooking]
                th Riesgos del #[i overbooking]
            tbody
              tr
              ...
              tr
                td Rentabilidad.
                td Incrementa los ingresos del establecimiento al compensar cancelaciones y #[i no show].
      ...
      .col-lg-12
        .bg-fondo-10.px-lg-5.py-lg-4.px-4.py-3.br-15
          .row.align-items-center
            ...
            .col-lg
              p.mb-0 El overbooking es una estrategia utilizada en hotelería para optimizar la ocupación y maximizar los ingresos del establecimiento, especialmente en temporadas de alta demanda. Sin embargo, su implementación requiere un análisis cuidadoso de las tendencias de cancelación y no show, así como un control permanente de la disponibilidad. Una adecuada gestión del overbooking permite equilibrar rentabilidad y calidad del servicio, mientras que un manejo inadecuado puede afectar la experiencia del huésped y la imagen del hotel.
