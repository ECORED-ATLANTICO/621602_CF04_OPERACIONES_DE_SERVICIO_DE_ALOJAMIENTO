      ...
      preguntas: [
        {
          id: 1,
          texto:
            'Los canales directos de reserva permiten que el cliente contacte al hotel sin intermediarios.',
        ...
        },
        {
          id: 5,
          texto:
            'Una reserva garantizada cuenta con respaldo económico o financiero.',
          imagen: require('@/assets/actividad/imagen1.png'),
          barajarRespuestas: false,
          opciones: [
            { id: 'a', texto: 'Verdadero', esCorrecta: true },
        ...
        },
        {
          id: 6,
          texto:
            'La codificación de reservas no tiene relación con los sistemas PMS.',
          imagen: require('@/assets/actividad/imagen1.png'),
          barajarRespuestas: false,
          opciones: [
            { id: 'a', texto: 'Verdadero', esCorrecta: false },
        ...
        {
          id: 8,
          texto: 'Las políticas de cancelación no deben informarse al huésped.',
          imagen: require('@/assets/actividad/imagen1.png'),
          barajarRespuestas: false,
          opciones: [
            { id: 'a', texto: 'Verdadero', esCorrecta: false },
        ...
        },
        {
          id: 9,
          texto:
            'Las OTA son agencias de viajes <i>online</i> utilizadas para comercializar servicios turísticos.',
          imagen: require('@/assets/actividad/imagen1.png'),
          barajarRespuestas: false,
          opciones: [
            { id: 'a', texto: 'Verdadero', esCorrecta: true },
        ...
        },
        {
          id: 10,
          texto:
            'La anulación de una reserva generalmente ocurre por errores o inconsistencias en el sistema.',
        ...
        },
        {
          id: 12,
          texto:
            'Los códigos IATA son utilizados para identificar aeropuertos y ciudades.',
        ...
        },
        {
          id: 13,
          texto:
            'Las reservas provisionales ya están completamente confirmadas y garantizadas.',
          imagen: require('@/assets/actividad/imagen3.png'),
          barajarRespuestas: false,
          opciones: [
            { id: 'a', texto: 'Verdadero', esCorrecta: false },
        ...
        },
        {
          id: 14,
          texto:
            'El tratamiento de la reserva incluye registro, confirmación y seguimiento de la información del huésped.',
